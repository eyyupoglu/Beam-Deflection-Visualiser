...
# -*- coding: utf-8 -*-
"""
RegularCheckFunction for load positions&forces and clear screen
"""
...
def clear_screen():
    #This function checks the operation system and if it is windows then it uses cls command to clear the screen
    #Otherwise it uses clear to clean screen.
